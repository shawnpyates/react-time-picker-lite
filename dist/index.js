...
var getUpdatedTimeChars = function getUpdatedTimeChars(charArr, charStr) {
  var hourColumn = charStr.split(':')[0];
  var updatedHour = hourColumn.length > 1 ? hourColumn.split('') : ['-', hourColumn];
...
function TimePicker(_ref) {
  var placeholderText = _ref.placeholderText,
    ...
    return null;
      ...
      _ref$shouldUse24HourM = _ref.shouldUse24HourMode,
      shouldUse24HourMode = _ref$shouldUse24HourM === void 0 ? false : _ref$shouldUse24HourM;
  ...
  var enableTimePicker = function enableTimePicker() {
    var updatedTimeCharsArray = timeCharsString ? getUpdatedTimeChars(timeCharsArray, timeCharsString) : timeCharsArray;
